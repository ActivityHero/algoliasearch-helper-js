...
function filterFacetValues(parentPath, currentRefinement, hierarchicalSeparator, hierarchicalRootPath,
  ...
  return function(facetCount, facetValue) {
    // we want the facetValue to be under the hierarchicalPrefix in the tree
    if (hierarchicalRootPath &&
      facetValue.split(hierarchicalSeparator).length <= hierarchicalRootPath.split(hierarchicalSeparator).length) {
      return false;
    }
